...
export default function EmployerIntakePortal() {
  ...
  const validateForm = () => {
    ...
    if (!formData.employeeCountFulltime) newErrors.employeeCountFulltime = 'Employee count is required';
  ...
  return (
    <div style={{ minHeight: '100vh', background: COLORS.gray }}>
      ...
      <div style={{ maxWidth: '720px', margin: '-40px auto 40px', padding: '0 20px' }}>
        ...
        {(formData.entityType === 'School District' || formData.isSchoolDistrict) && (
        ...
        <FormSection
          number={formData.entityType === 'School District' ? "4" : "3"}
        ...
        <FormSection
          number={formData.entityType === 'School District' ? "5" : "4"}
        ...
        <FormSection
          number={formData.entityType === 'School District' ? "6" : "5"}
        ...
        <FormSection
          number={formData.entityType === 'School District' ? "7" : "6"}
        ...
        <FormSection
          number={formData.entityType === 'School District' ? "8" : "7"}
        ...
        <FormSection
          number={formData.entityType === 'School District' ? "9" : "8"}
        ...
        >
          <div style={{
            ...
            <ul style={{
              ...
              <li>I understand that enrollment is voluntary and employees may opt out</li>
            </ul>
          </div>
        ...
        <div style={{ textAlign: 'center', padding: '20px 0 40px' }}>
          <button
            ...
            onMouseOver={(e) => {
              ...
              e.target.style.boxShadow = '0 6px 20px rgba(122, 193, 67, 0.5)';
            }}
            onMouseOut={(e) => {
              e.target.style.transform = 'translateY(0)';
              e.target.style.boxShadow = '0 4px 14px rgba(122, 193, 67, 0.4)';
            }}
          >
            Submit Intake Form
          </button>
